(function (global, factory) {
  ...
  var MediaLink = /** @class */ (function () {
      ...
      MediaLink.prototype.getImage = function () {
          return this.connection.request(exports.MEDIA_LINK.IMAGE_GET, null, {
              timeout: false
          });
      };
      /**
      ...
      MediaLink.prototype.getImages = function (_a) {
          ...
          return this.connection.request(exports.MEDIA_LINK.IMAGE_GET, { max: max }, { timeout: false });
      };
      /**
      ...
      MediaLink.prototype.getVideo = function () {
          return this.connection.request(exports.MEDIA_LINK.VIDEO_GET, null, {
              timeout: false
          });
      };
      /**
      ...
      MediaLink.prototype.getVideos = function (_a) {
          var max = (_a === void 0 ? { max: null } : _a).max;
          return this.connection.request(exports.MEDIA_LINK.VIDEO_GET, { max: max }, {
              timeout: false
          });
      };
      return MediaLink;
      ...
      ContentLink.prototype.fetchLinks = function (contentTypeIds, max) {
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                  ...
                  return [2 /*return*/, this.connection.request(exports.CONTENT_LINK.CONTENT_GET, response, {
                          timeout: false
                      })];
              });
          });
  ...
  ***************************************************************************** */
  ...
  var ContentReference = /** @class */ (function () {
      ...
      ContentReference.prototype.fetchReferences = function (contentTypeIds, max) {
          ...
          return this.connection.request(exports.CONTENT_REFERENCE.CONTENT_REF_GET, response, {
              timeout: false
          });
      };
